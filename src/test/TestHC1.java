...
public class TestHC1 {
	...
	public void startTest() {
		...
		HC1 hc1SecureRandom = new HC1(START_VALUE, TEST_LCG_FILE_PATH, TEST_LCG_FILE_ENCRYPT_PATH);
		HC1 hc2SecureRandom = new HC1(START_VALUE, TEST_LCG_FILE_ENCRYPT_PATH, TEST_LCG_FILE_DECRYPT_PATH);
